        ...
        <div className='background'>
            <div className='second-section'>
                ...
                <div className='card-container'>
                    ...
                    <Card image={<MdOutlineComputer />} heading={"Pokročilý nástroj pro odesílání"} text={"Usnadněte si odesílání zásilek s novým nástrojem."} />
                    <Card image={<PiBookOpenText />} heading={"Přehledný systém"} text={"Adresáře, online fakturace a reportování."} />
                    <Card image={<PiPackageBold />} heading={"Přeprava pro e-commerce"} text={"Zaregistrujte se a získej výhodný poměrem rychlosti a ceny."} />
                </div>
            </div>
